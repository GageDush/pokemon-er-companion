export const TYPE_EFFECTIVENESS: Record<string, { weakTo: string[]; resists: string[]; immuneTo: string[] }> = {
  ...
  Dragon: { weakTo: ["Ice", "Dragon", "Fairy"], resists: ["Fire", "Water", "Grass", "Electric"], immuneTo: [] },
